                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                            	...
                                            	<button class="view_data btn btn-sm btn-warning" data-bs-tonggle="modal" data-bs-target="#myModal" id="<?php echo $res['id_siswa']; ?>">Edit</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" method="POST">
            ...
            <input type="text" name="telp" placeholder="No Telepon" class="form-control mb-2">
...
<?php 
error_reporting(0); //ben gak muncul eror e
if(isset($_POST['simpan'])) {
    $nama_siswa = htmlentities(strip_tags(ucwords($_POST['nama_siswa'])));
    $username = htmlentities(strip_tags(ucwords($_POST['username'])));
    $password = htmlentities(strip_tags(ucwords($_POST['password'])));
    $no_telp = htmlentities(strip_tags(ucwords($_POST['telp'])));
    $level = 'siswa';
    ...
    $exec = $conn -> query($query);
     $karep = $conn -> query("INSERT INTO tb_user1
                (nama_lengkap,username,password,nisn,telp,level)
                values 
                ('$nama_siswa','$username','$password','$nisn','$no_telp','$level')");
