                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?= $res ['biaya'] ?></td>
                                            <td>
                                            <a class="view_data btn btn-sm btn-warning" data-bs-tonggle="modal" data-bs-target="#myModal" id="<?php echo $res['id_angkatan']; ?>">Edit</a>
...
if(isset($_POST['edit'])) {   
    ...
    $query = "UPDATE angkatan SET 
                                nama_angkatan = '$nama_angkatan',
                                biaya = '$biaya' WHERE id_angkatan = '$id_angkatan'";
