...
<!-- Page Heading -->
  ...
  <fieldset disabled>
    ...
    <div class="mb-3">
        ...
        <label for="disabledTextInput" class="form-label text-dark fw-bold fs-2" >Nisn</label>
        <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $row['nisn']; ?>">
